...
public abstract class CustomAutonomous extends LinearOpMode
{
    ...
    public static final int MR_COLOR_THRESHOLD = 1;
    public static final int REV_COLOR_THRESHOLD = 25;
    ...
    public static final int USDIGITAL_E4T_TICKS = 360;
    public static final int USDIGITAL_E4P_TICKS = 360;
